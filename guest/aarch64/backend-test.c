...
#define INSTRUCTION_STP_XZR_XZR_X9 UINT32_C(0xa9007d3f)
...
static void test_fast_dispatch_structure(void) {
    ...
    _Static_assert(array_size(hot_instructions) == 29,
            "threaded 热点结构门必须覆盖全部 29 个 opcode");
