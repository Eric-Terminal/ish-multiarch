...
enum aarch64_opcode {
    ...
    AARCH64_OP_LOAD_SIMD_REPLICATE_1,
    ...
    AARCH64_OP_ADVSIMD_SHL,
    AARCH64_OP_ADVSIMD_SSHR,
    AARCH64_OP_ADVSIMD_USHR,
    ...
    AARCH64_OP_ADVSIMD_MUL,
    AARCH64_OP_ADVSIMD_FADD,
    AARCH64_OP_ADVSIMD_FSUB,
    AARCH64_OP_ADVSIMD_FMUL,
    AARCH64_OP_ADVSIMD_SADDW,
    AARCH64_OP_ADVSIMD_SADDW2,
    AARCH64_OP_ADVSIMD_UADDW,
    AARCH64_OP_ADVSIMD_UADDW2,
    AARCH64_OP_ADVSIMD_SSUBW,
    AARCH64_OP_ADVSIMD_SSUBW2,
    AARCH64_OP_ADVSIMD_USUBW,
    AARCH64_OP_ADVSIMD_USUBW2,
    AARCH64_OP_ADVSIMD_UQSUB_SCALAR,
    AARCH64_OP_ADVSIMD_ADDV,
    AARCH64_OP_ADVSIMD_NEG,
    ...
    AARCH64_OP_FCVTZU_GENERAL,
    AARCH64_OP_FCVTMU_GENERAL,
    AARCH64_OP_FCVTMS_GENERAL,
    AARCH64_OP_FCVTNS_GENERAL,
    AARCH64_OP_FCVTNU_GENERAL,
    AARCH64_OP_FCVTPS_GENERAL,
    AARCH64_OP_FCVTPU_GENERAL,
    AARCH64_OP_FCVTAS_GENERAL,
    AARCH64_OP_FCVTAU_GENERAL,
    AARCH64_OP_FADD_SCALAR,
    AARCH64_OP_FSUB_SCALAR,
    AARCH64_OP_FMUL_SCALAR,
    AARCH64_OP_FMADD_SCALAR,
    AARCH64_OP_FMSUB_SCALAR,
    AARCH64_OP_FNMADD_SCALAR,
    AARCH64_OP_FNMSUB_SCALAR,
    AARCH64_OP_FDIV_SCALAR,
    AARCH64_OP_FCSEL_SCALAR,
    AARCH64_OP_FNEG_SCALAR,
    AARCH64_OP_FABS_SCALAR,
    AARCH64_OP_FMIN_SCALAR,
    AARCH64_OP_FMAX_SCALAR,
    AARCH64_OP_FMINNM_SCALAR,
    AARCH64_OP_FMAXNM_SCALAR,
    AARCH64_OP_FRINTM_SCALAR,
    AARCH64_OP_FRINTN_SCALAR,
    AARCH64_OP_FRINTP_SCALAR,
    AARCH64_OP_FRINTZ_SCALAR,
    AARCH64_OP_FRINTA_SCALAR,
    AARCH64_OP_FRINTI_SCALAR,
    AARCH64_OP_FRINTX_SCALAR,
    AARCH64_OP_FSQRT_SCALAR,
    AARCH64_OP_FMOV_SCALAR,
    AARCH64_OP_FCVT_SCALAR,
    AARCH64_OP_FMOV_IMMEDIATE,
    AARCH64_OP_FCMP_SCALAR,
    AARCH64_OP_FCMPE_SCALAR,
    AARCH64_OP_FCCMP_SCALAR,
    AARCH64_OP_FCCMPE_SCALAR,
    AARCH64_OP_FCVTZS_SCALAR,
    AARCH64_OP_FCVTZU_SCALAR,
