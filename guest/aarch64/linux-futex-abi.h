...
#define AARCH64_LINUX_FUTEX_WAITERS UINT32_C(0x80000000)
#define AARCH64_LINUX_FUTEX_OWNER_DIED UINT32_C(0x40000000)
#define AARCH64_LINUX_FUTEX_TID_MASK UINT32_C(0x3fffffff)
...
#define AARCH64_LINUX_ROBUST_LIST_LIMIT UINT32_C(2048)
