...
#define ISH_APPLE_COMMAND_ARGUMENT_COUNT_MAX 4096U
#define ISH_APPLE_COMMAND_ARGUMENT_BYTES_MAX 131072U
#define ISH_APPLE_COMMAND_PATH_BYTES_MAX 4096U
#define ISH_APPLE_COMMAND_OUTPUT_CHUNK_MAX 16384U
#define ISH_APPLE_COMMAND_STDIN_WRITE_BYTES_MAX 2147483647U
#define ISH_APPLE_COMMAND_OUTPUT_BYTES_DEFAULT 8388608ULL
#define ISH_APPLE_COMMAND_OUTPUT_BYTES_MAX 67108864ULL
#define ISH_APPLE_COMMAND_OUTPUT_BYTES_DISABLED UINT64_MAX
#define ISH_APPLE_COMMAND_TIMEOUT_MS_DEFAULT 300000U
#define ISH_APPLE_COMMAND_TIMEOUT_MS_MAX 3600000U
#define ISH_APPLE_COMMAND_TIMEOUT_MS_DISABLED UINT32_MAX

#define ISH_APPLE_COMMAND_STREAM_STDOUT 1U
#define ISH_APPLE_COMMAND_STREAM_STDERR 2U

#define ISH_APPLE_COMMAND_COMPLETION_EXITED 1
#define ISH_APPLE_COMMAND_COMPLETION_SIGNALED 2
#define ISH_APPLE_COMMAND_COMPLETION_CANCELLED 3
#define ISH_APPLE_COMMAND_COMPLETION_TIMED_OUT 4
#define ISH_APPLE_COMMAND_COMPLETION_OUTPUT_LIMIT 5
#define ISH_APPLE_COMMAND_COMPLETION_RUNTIME_FAILURE 6
