...
#define ISH_APPLE_DIAGNOSTIC_SCOPE_RUNTIME 1U
#define ISH_APPLE_DIAGNOSTIC_SCOPE_COMMAND 2U
#define ISH_APPLE_DIAGNOSTIC_SCOPE_TERMINAL 3U
#define ISH_APPLE_DIAGNOSTIC_SCOPE_GUEST_FILE 4U

#define ISH_APPLE_DIAGNOSTIC_CATEGORY_INSTRUCTION 1U
#define ISH_APPLE_DIAGNOSTIC_CATEGORY_SYSCALL 2U
#define ISH_APPLE_DIAGNOSTIC_CATEGORY_FILESYSTEM 3U
#define ISH_APPLE_DIAGNOSTIC_CATEGORY_RUNTIME 4U

#define ISH_APPLE_DIAGNOSTIC_INSTRUCTION_UNDEFINED 1U
#define ISH_APPLE_DIAGNOSTIC_SYSCALL_UNSUPPORTED 1U
#define ISH_APPLE_DIAGNOSTIC_FILESYSTEM_UNSUPPORTED 1U
#define ISH_APPLE_DIAGNOSTIC_RUNTIME_START_FAILED 1U
#define ISH_APPLE_DIAGNOSTIC_RUNTIME_BRIDGE_FAILED 2U

#define ISH_APPLE_DIAGNOSTIC_ARCHITECTURE_AARCH64 1U

#define ISH_APPLE_DIAGNOSTIC_BACKEND_UNKNOWN 0U
#define ISH_APPLE_DIAGNOSTIC_BACKEND_C 1U
#define ISH_APPLE_DIAGNOSTIC_BACKEND_THREADED 2U
