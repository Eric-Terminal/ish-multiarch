...
#define ISH_APPLE_GUEST_FILE_PATH_BYTES_MAX UINT32_C(4095)
#define ISH_APPLE_GUEST_FILE_NAME_BYTES_MAX UINT32_C(255)

#define ISH_APPLE_GUEST_FILE_REQUEST_NOFOLLOW UINT32_C(1)

#define ISH_APPLE_GUEST_FILE_REMOVE_RECURSIVE UINT32_C(1)
#define ISH_APPLE_GUEST_FILE_MKDIR_PARENTS UINT32_C(1)
