...
#define ISH_APPLE_MOUNT_ACCESS_READ_ONLY INT32_C(1)
#define ISH_APPLE_MOUNT_ACCESS_READ_WRITE INT32_C(2)

#define ISH_APPLE_MOUNT_STATE_STAGED INT32_C(1)
#define ISH_APPLE_MOUNT_STATE_ACTIVE INT32_C(2)
#define ISH_APPLE_MOUNT_STATE_DRAINING INT32_C(3)
#define ISH_APPLE_MOUNT_STATE_REMOVED INT32_C(4)

#define ISH_APPLE_MOUNT_REMOVE_FORCE UINT32_C(1)
#define ISH_APPLE_MOUNT_GUEST_DIRECTORY_BYTES_MAX UINT32_C(4095)
