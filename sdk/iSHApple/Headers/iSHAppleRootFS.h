...
#define ISH_APPLE_ROOTFS_INSTALL_RESULT_INSTALLED 0
#define ISH_APPLE_ROOTFS_INSTALL_RESULT_ALREADY_PRESENT 1

#define ISH_APPLE_ROOTFS_ARCHIVE_PHASE_VERIFY 1U
#define ISH_APPLE_ROOTFS_ARCHIVE_PHASE_EXTRACT 2U
#define ISH_APPLE_ROOTFS_ARCHIVE_PHASE_VALIDATE_SEED 3U
#define ISH_APPLE_ROOTFS_ARCHIVE_PHASE_PUBLISH 4U
#define ISH_APPLE_ROOTFS_ARCHIVE_PHASE_COMPLETE 5U

#define ISH_APPLE_ROOTFS_ARCHIVE_PROGRESS_PATH_TRUNCATED 1U

#define ISH_APPLE_ROOTFS_ARCHIVE_PROGRESS_CONTINUE 0
#define ISH_APPLE_ROOTFS_ARCHIVE_PROGRESS_CANCEL 1

#define ISH_APPLE_ROOTFS_ARCHIVE_PROGRESS_PATH_BYTES 512U
