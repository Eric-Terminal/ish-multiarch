...
#define ISH_APPLE_RUNTIME_PHASE_IDLE 0
#define ISH_APPLE_RUNTIME_PHASE_PREPARING 1
#define ISH_APPLE_RUNTIME_PHASE_RUNNING 2
#define ISH_APPLE_RUNTIME_PHASE_STOPPED 3
#define ISH_APPLE_RUNTIME_PHASE_FAILED 4

#define ISH_APPLE_RUNTIME_SOCKET_PREFIX_BYTES_MAX 82U
#define ISH_APPLE_RUNTIME_HOSTNAME_BYTES_MAX 64U
#define ISH_APPLE_RUNTIME_BOOT_COMMAND_BYTES_MAX 4095U

#define ISH_APPLE_RUNTIME_CAPABILITY_PTY 1ULL
#define ISH_APPLE_RUNTIME_CAPABILITY_LIVE_MOUNTS 2ULL
#define ISH_APPLE_RUNTIME_CAPABILITY_DIAGNOSTICS 4ULL
#define ISH_APPLE_RUNTIME_CAPABILITY_GUEST_FILES 8ULL

#define ISH_APPLE_RUNTIME_ARCHITECTURE_AARCH64 1U

#define ISH_APPLE_RUNTIME_BACKEND_UNKNOWN 0U
#define ISH_APPLE_RUNTIME_BACKEND_C 1U
#define ISH_APPLE_RUNTIME_BACKEND_THREADED 2U
