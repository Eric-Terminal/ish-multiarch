...
#define ISH_APPLE_TERMINAL_IO_BYTES_MAX 2147483647U

#define ISH_APPLE_TERMINAL_COMPLETION_EXITED 1
#define ISH_APPLE_TERMINAL_COMPLETION_SIGNALED 2
#define ISH_APPLE_TERMINAL_COMPLETION_CANCELLED 3
#define ISH_APPLE_TERMINAL_COMPLETION_RUNTIME_FAILURE 4
